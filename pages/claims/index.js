                      ...
                      {(process.env.enforceWhitelist == false || currentUseState.xmPower.isWhiteListed == true) ?
                        <>
                          {(currentUseState.isWaiting == false) ?
                            <>
                              <label className="connected">Number of Claimable Sloths (1-{currentUseState.whiteListPass.q}):</label>
                              <div className="">
                            ...
                            <>
                              <hr />
                              <h1 className="subtitle font-light" style={{ color: "#ffffff"}}>Communicating with the blockchain!</h1>
                            </>}
                        </>
                        : <h1 className="subtitle font-light" style={{ color: "#ffffff"}}>You are not on the whitelist</h1>
                      }
                      <a
                        onClick={() => walletBridge1.disconnect()}
                        className="btn btn-md m-t-30 btn-outline-light " style={{ backgroundColor: "#226534" }}
